...
class AjeraClient(BaseAjeraClient):
    ...
    def get_timesheets(self, timesheet_keys: list[int]) -> list[TimesheetDetails]:
        """
        ...
        """
        return self._run(timesheet_ops.get_timesheets(timesheet_keys))
    ...
    def update_timesheet(
        ...
        *,
        ...
        """
        timesheets = self.get_timesheets([timesheet_key])
        if not timesheets:
